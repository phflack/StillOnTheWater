Shader "RippleToon" {
    ...
    SubShader {
        ...
        void vert (inout appdata_full v) {
            v.vertex.xyz += v.normal * .003 * sin(v.vertex.y + _Time.w);
        }
        ...
        float4 LightingStepped(ToonSurfaceOutput s, float3 lightDir, half3 viewDir, float shadowAttenuation){
            ...
            color.rgb = s.Albedo * lightIntensity * _LightColor0.rgb * shadowAttenuation;
        ...
        void surf (Input i, inout ToonSurfaceOutput o) {
            ...
            // o.Emission = i.color;
            o.Emission = float4(i.uv_MainTex, 0, 1);
        }
        ENDCG
    }
    FallBack "Standard"
